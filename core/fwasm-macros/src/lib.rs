...
pub fn init(_attr: TokenStream, func: TokenStream) -> TokenStream {
    ...
    let func_name = format_ident!("__fwasm_init_{}", &func_decl.ident);
...
#[proc_macro_attribute]
pub fn encrypt(attr: TokenStream, func: TokenStream) -> TokenStream {
    expand(attr, func, "__fwasm_encrypt_")
}

#[proc_macro_attribute]
pub fn decrypt(attr: TokenStream, func: TokenStream) -> TokenStream {
    expand(attr, func, "__fwasm_decrypt_")
}
